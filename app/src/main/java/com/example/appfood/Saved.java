...
public class Saved extends AppCompatActivity implements SearchView.OnQueryTextListener , RecycleViewOnItemClick{
        ...
        navigation.setOnItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.saved:
                    return true;
                case R.id.home:
                    Intent a = new Intent(Saved.this,MainActivity.class);
                    startActivity(a);
                    overridePendingTransition(0,0);
                    return true;

                case R.id.search:
                    Intent b = new Intent(Saved.this,Search.class);
                    startActivity(b);
                    overridePendingTransition(0,0);
                    return true;
                case R.id.upload:
                    Intent c = new Intent(Saved.this,Upload.class);
                    startActivity(c);
                    overridePendingTransition(0,0);
                    return true;
            }
